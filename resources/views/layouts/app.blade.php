...
<body class="bg-[#f5f3ef] antialiased">
    <div class="min-h-screen">
        <nav class="bg-white border-b border-[#e8e4dc]">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 flex items-center gap-2">
                            <div class="p-1.5 rounded-lg text-white" style="background: #e8650a;">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path>
                                </svg>
                            </div>
                            <span class="text-xl font-bold text-slate-900 tracking-tight">IT<span style="color: #e8650a;">Connect</span></span>
                        </div>
                    </div>
